...
@section('content')
    ...
    <form method="post" action="{{ route('training-sessions.store')}}">
        ...
        <div class="form-group">
            ...
            <input type="text" id="session_name" placeholder="Salsa..." class="form-control" name="SessionName"
        ...
        <div class="form-group">
            ...
            <input type="time" id="session_finish_time" class="form-control" name="finish_time"
        ...
        <div class="form-group">
            <div class="select2-purple">
                ...
                <select id="coach_select" name="users[]" class="select2" multiple="multiple"
                        data-placeholder="select coach" data-dropdown-css-class="select2-purple" style="width: 100%" ;>
