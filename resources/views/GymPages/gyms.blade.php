@extends('layouts.app')
@section('content')
    <h1 class="text-center">All Gym</h1>
    <div class="row">
      <div class="col-12">
        <div class="card">
              ...
              <tr>
                ...
                <td class="d-flex justify-content-center">
                  <a href="{{ route('show.singleGym',['gymId'=>$gym['id']]) }}" class="m-3">
                    ...
                    <form method="post" action="{{ route('delete.gym',['gymId'=>$gym['id'] ]) }}" style="display: inline-block;">
                        @csrf
                        @method('delete')
                        <button type="submit"  class="btn m-3 " onclick="return confirm('Are you sure?')">
