...
<div class="card card-primary card-outline">
    <div class="card-body box-profile">
        <div class="text-center">
            <img class="profile-user-img img-fluid img-circle" style="width:100px;height:100px;" src="{{asset(auth()->user()->avatar)}}" alt="User profile picture">
        </div>
        ...
        <ul class="list-group list-group-unbordered mb-3">
            ...
            <li class="list-group-item">
                ...
                <li class="list-group-item">
                    <b>City</b> <a class="float-right">{{auth()->user()->manager->city ?auth()->user()->manager->city->name : "Not Assigned"}}</a>
                </li>
                @else
                <li class="list-group-item">
                    <b>Gym Name</b> <a class="float-right">{{auth()->user()->manager->gym ? auth()->user()->manager->gym->name : "Not Assigned"}}</a>
                </li>
                @endif
            @endif
