...
<form method="post" action="{{ route('profile.update')}}">
    ...
    <div class="form-group">
        ...
        <input id="national_id" type="text" class="form-control" name="national_id" value="{{auth()->user()->manager->national_id}}">
    </div>
    @endif
    @if(auth()->user()->hasRole('Client'))
    <div class="form-group">
        <label for="dob">Date Of Birth </label>
        <input id="dob" type="date" class="form-control" name="dateofbirth" value="{{auth()->user()->client->date_of_birth}}">
    </div>
    @endif
    <!--  <div class="form-group">
        <label>Gender </label>
